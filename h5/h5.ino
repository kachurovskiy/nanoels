...
const long BACKLASH_DU_X = 0; // 0mm backlash in deci-microns (10^-7 of a meter)
...
/* Removed duplicate keycode block to avoid redefinitions; keeping upstream mappings below */
